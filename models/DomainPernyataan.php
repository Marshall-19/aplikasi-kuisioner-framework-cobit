...
class DomainPernyataan extends Models {
  ...
  public function detailDataDomain($domain_id) {
    return $this->db->query("Select
                                  ...
                                  tbl_domain.domain_keterangan,
                                  tbl_domain.domain_nama,
                                  tbl_domain.domain_id,
                              ...
                              From
                                  ...
                                  tbl_domain On tbl_pernyataan.domain_id = tbl_domain.domain_id WHERE tbl_domain.domain_id = :domain_id  
                              GROUP BY tbl_domain.domain_id", ["domain_id" => $domain_id])->fetch(PDO::FETCH_ASSOC);
  }
}
